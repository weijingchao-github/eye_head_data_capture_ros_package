...
def main():
    ...
    eye_gaze_yaw_angle, eye_gaze_pitch_angle = (-1, -1)
    depth_to_base = -1
    target_3d_position_in_base = (-1, -1, -1)
    head_pose_quaternion_in_camera_coordinate = (-1, -1, -1, -1)  # x y z w格式
    head_pose_quaternion_in_camera_coordinate = UnitQuaternion(
        [
            head_pose_quaternion_in_camera_coordinate[3],
            head_pose_quaternion_in_camera_coordinate[0],
            head_pose_quaternion_in_camera_coordinate[1],
            head_pose_quaternion_in_camera_coordinate[2],
        ]
    )  # 转为spatialmath库所需的w x y z格式
