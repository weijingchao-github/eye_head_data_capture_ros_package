...
class DataCollector:
    ...
    def sync_callback(self, image_msg, imu_msg):
        ...
        if relative_time <= self.duration:
            ...
            self.synced_image_data.append({"timestamp": timestamp, "image": image_msg})
    ...
    def save_data_to_csv(self):
        ...
        for synced_imu_data in self.synced_imu_data:
            ...
            quaternion = (
                synced_imu_data["quaternion"].x,
                synced_imu_data["quaternion"].y,
                synced_imu_data["quaternion"].z,
                synced_imu_data["quaternion"].w,
            )
