...
import cv2
import numpy as np
from get_point_from_image import select_points_on_image
from PIL import Image


class GetEyeGazeDirection:
    def __init__(self, human_parameters, monitor):
        # Detect blink setup
    ...
    def pipeline(self, image_raw):
        # 人脸对齐
        eye_corners_facial_landmarks = select_points_on_image(
            image_raw, 2, self.monitor
        )
        aligned_image = self._align_face(image_raw, eye_corners_facial_landmarks)
        # 人脸特征点检测
        facial_landmarks = select_points_on_image(aligned_image, 10, self.monitor)

        # facial_landmarks = facial_landmarks[1]
        # image_with_eye_facial_landmarks = self._plot_eye_facial_landmarks(
        #     facial_landmarks, aligned_image
        # )
        # cv2.imwrite(
        #     "image_with_eye_facial_landmarks.jpg", image_with_eye_facial_landmarks
        # )
        # # 眨眼检测
    ...
    def _calculate_eye_position(self, facial_landmarks, image):
        eye_left_landmarks = {
            "left_corner": facial_landmarks[0],
            "right_corner": facial_landmarks[2],
            "pupil": facial_landmarks[4],
        }
        eye_right_landmarks = {
            "left_corner": facial_landmarks[5],
            "right_corner": facial_landmarks[7],
            "pupil": facial_landmarks[9],
        }
    ...
    def _plot_eye_facial_landmarks(self, facial_landmarks, image_facial_landmarks_plot):
        ...
        image_height, image_width = (
            image_facial_landmarks_plot.shape[0],
            image_facial_landmarks_plot.shape[1],
        )
        num_list = [
            33,
            246,
...
# def main():
#     image_path = "/home/wjc/Storage/humanoid_head/eye_head_data_capture/src/yesense/scripts/captured_data_3/20250707_105422/face_image/1751856869.1082790.jpg"
